#! Palavras reconhecidas pela coloração de sintaxe do Tinn-R
...
#Comentários
pA = 2i                             #Números complexos
pB = 3.5E2                          #Números fracionários
variable_a = 1:100                  #Identificadores
#!Notes and observations
012345689                           #Numeros
+ - * / ^ = <- -> <> ~ $ ? ! & :    #Operadores
NA, NULL, TRUE, FALSE, if           #Reserveda_1
mean(A); mean(B); sd(A)             #Reserveda_2
plot(B ~ A, ylab = 'B', xlab = 'A',
     col = 'blue', cex = 0.5)       #Reserveda_3
