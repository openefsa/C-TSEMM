#! Mots reconnus pour la coloration syntaxique de Tinn-R
...
#Commentaires
pA = 2i                             #Nombres complexes
pB = 3.5E2                          #Nombres en virgule flottante
variable_a = 1:100                  #Identifiants
#!Notes et observations
012345689                           #Nombres
+ - * / ^ = <- -> <> ~ $ ? ! & :    #Opérateurs
NA, NULL, TRUE, FALSE, if           #Réservés_1
mean(A); mean(B); sd(A)             #Réservés_2
plot(B ~ A, ylab = 'B', xlab = 'A',
     col = 'blue', cex = 0.5)       #Réservés_3
stringA = "Ceci est" 'une chaine de caractères'
() {} [] ; ,                        #Symboles
