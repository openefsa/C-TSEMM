#! Palabras reconocidad para resaltar de Tinn-R
...
#Comentarios
pA = 2i                             #Numeros complejos
pB = 3.5E2                          #Numeros flotantes
variable_a = 1:100                  #Identificadores
#!Notas y observaciones
012345689 #Numeros
+ - * / ^ = <- -> <> ~ $ ? ! & :    #Operadores
NA, NULL, TRUE, FALSE, if           #Reservado_1
mean(A); mean(B); sd(A)             #Reservado_2
plot(B ~ A, ylab = 'B', xlab = 'A',
     col = 'blue', cex = 0.5)       #Reservado_3
stringA = "Esto es" 'una cadena'
() {} [] ; ,                        #Símbolo
