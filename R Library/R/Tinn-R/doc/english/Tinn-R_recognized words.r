#! Recognized words for the Highlight of the Tinn-R
...
#Comments
pA = 2i                             #Complex number
pB = 3.5E2                          #Float number
variable_a = 1:100                  #Identifier
#!Notes and observations
012345689 #Numbers
+ - * / ^ = <- -> <> ~ $ ? ! & :    #Operators
NA, NULL, TRUE, FALSE, if           #Reserved_1
mean(A); mean(B); sd(A)             #Reserved_2
plot(B ~ A, ylab = 'B', xlab = 'A',
     col = 'blue', cex = 0.5)       #Reserved_3
