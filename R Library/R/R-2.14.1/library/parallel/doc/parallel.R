...
###################################################
### code chunk number 1: parallel.Rnw:462-463 (eval = FALSE)
###################################################
## library(parallel)


###################################################
### code chunk number 2: parallel.Rnw:488-495 (eval = FALSE)
###################################################
## library(boot)
...
###################################################
### code chunk number 3: parallel.Rnw:500-510 (eval = FALSE)
###################################################
## cd4.rg <- function(data, mle) MASS::mvrnorm(nrow(data), mle$m, mle$v)
## cd4.mle <- list(m = colMeans(cd4), v = var(cd4))
...
###################################################
### code chunk number 4: parallel.Rnw:515-516 (eval = FALSE)
###################################################
## do.call(c, lapply(seq_len(mc), run1))


###################################################
### code chunk number 5: parallel.Rnw:520-535 (eval = FALSE)
###################################################
## run1 <- function(...) {
##    library(boot)
##    cd4.rg <- function(data, mle) MASS::mvrnorm(nrow(data), mle$m, mle$v)
...
###################################################
### code chunk number 6: parallel.Rnw:545-558 (eval = FALSE)
###################################################
## cl <- makeCluster(mc)
## cd4.rg <- function(data, mle) MASS::mvrnorm(nrow(data), mle$m, mle$v)
## cd4.mle <- list(m = colMeans(cd4), v = var(cd4))
...
###################################################
### code chunk number 7: parallel.Rnw:563-577 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: parallel.Rnw:582-590 (eval = FALSE)
###################################################
## mc <- 9
...
###################################################
### code chunk number 9: parallel.Rnw:604-615 (eval = FALSE)
###################################################
## library(spatial)
...
###################################################
### code chunk number 10: parallel.Rnw:619-628 (eval = FALSE)
###################################################
## run3 <- function(c) {
##     library(spatial)
...
###################################################
### code chunk number 11: parallel.Rnw:632-636 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 12: parallel.Rnw:639-641 (eval = FALSE)
###################################################
## run4 <- function(c)  mean(replicate(R, tget(Strauss(69, c=c, r=3.5))))
